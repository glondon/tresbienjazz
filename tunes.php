	...
	<tr>
		...
		<td valign="top">
			...
			<ul>
				...
				<li>Ain’t Miss Behavin</li>
				<li>Afternoon In Paris</li>
				<li>A Night In Tunisia</li>
				<li>All Blues</li>
				<li>All of Me</li>
				...
				<li>Groove Merchant</li>
				<li>Hallelujah</li>
				<li>Here There, Everywhere</li>
				<li>Honky Tonk Train Blues</li>
